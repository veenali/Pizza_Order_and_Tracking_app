...
updateStatus(order); // Socket on client side ....... Add script tag on the layout folder to make the function available here.
...
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); //Create a copy of order


  updatedOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_3___default()().format(); // Update its update time
